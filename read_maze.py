    ...
    if not os.path.exists("COMP6247Maze20212022.npy"):
        ...
        for i in range(maze.shape[0]):
            for j in range(maze.shape[1]):
                ...
                # load the maze, with 1 denoting an empty location and 0 denoting action wall
                maze_cells[i][j][1] = 0  
